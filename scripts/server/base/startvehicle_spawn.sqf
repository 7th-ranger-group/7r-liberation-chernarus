...
for [{_i=0}, {!isNil ("f18_" + str _i)}, {_i = _i + 1}] do {
	private _KP_liberation_f18_pad = missionNamespace getVariable ("f18_" + str _i);
	private _KP_liberation_f18 = "JS_JC_FA18E" createVehicle [((getposATL _KP_liberation_f18_pad) select 0),((getposATL _KP_liberation_f18_pad) select 1),((getposATL _KP_liberation_f18_pad) select 2) + 0.2];
	_KP_liberation_f18 enableSimulationGlobal false;
	_KP_liberation_f18 allowdamage false;
	_KP_liberation_f18 setDir (getDir _KP_liberation_f18_pad);
	_KP_liberation_f18 setposATL [((getposATL _KP_liberation_f18_pad) select 0),((getposATL _KP_liberation_f18_pad) select 1),((getposATL _KP_liberation_f18_pad) select 2) + 0.2];
	if(KP_liberation_clear_cargo) then {
		clearWeaponCargoGlobal _KP_liberation_f18;
		clearMagazineCargoGlobal _KP_liberation_f18;
		clearItemCargoGlobal _KP_liberation_f18;
		clearBackpackCargoGlobal _KP_liberation_f18;
	};
	sleep 0.5;
	_KP_liberation_f18 enableSimulationGlobal true;
	_KP_liberation_f18 setDamage 0;
	_KP_liberation_f18 allowdamage true;
	_KP_liberation_f18 setVariable ["KP_liberation_preplaced", true, true];
};