...
GRLIB_save_key = "SR_LIBERATION_" + (toUpper worldName) + "_SAVEGAME";
...
KP_liberation_cr_kill_penalty = 20;																				// Civil Reputation penalty for killing a civilian.
KP_liberation_cr_building_penalty = 6;																			// Civil Reputation penalty for destroying/damaging a building.
KP_liberation_cr_vehicle_penalty = 4;																			// Civil Reputation penalty for stealing a civilian vehicle.
KP_liberation_cr_resistance_penalty = 6;																		// Civil Reputation penalty for killing a friendly resistance soldier.
